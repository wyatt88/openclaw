 ...
 */
function registerCodeAcceptRoute(_server: http.Server, pairingManager: PairingManager): void {
  // Dynamic import to get prependHttpHandler from gateway module
  void import("../gateway/server-http.js").then(({ prependHttpHandler }) => {
    prependHttpHandler(
